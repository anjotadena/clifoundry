...
def command(
    ...
    description: str = typer.Option("Command description.", "--desc", "-d", help="Description for the command"),
) -> None:
...
def service(
    ...
    description: str = typer.Option("Service description.", "--desc", "-d", help="Description for the service"),
) -> None:
...
'''
    ...
    print(f"  2. Import in your command: [dim]from clifoundry.services.{service_name} import {class_name}[/dim]")
